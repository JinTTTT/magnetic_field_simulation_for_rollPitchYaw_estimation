#!/usr/bin/env python3
"""Sensor 1's magnetic-field vector across an ideal 360 deg pitch sweep.

Yaw and roll are zero. Positive pitch rotates Sensor 1 about the Y axis that
passes through the magnet center; every vector is expressed in Sensor 1's
co-rotating frame.
"""
...
from ideal_configuration import build_ideal_magnet, sensor_1_field_at_pitch_mT
from sweep_plotting import add_rotation_triad, add_sweep_header, style_field_axes


OUTPUT_PATH = IDEAL_DIR / "plots" / "sensor1_pitch_sweep.png"
...
def main():
    ...
    cardinal_styles = (
        (0, "#c0392b", (0.35, 0.0, 0.25)),
        (90, "0.35", (0.20, 0.0, 0.30)),
