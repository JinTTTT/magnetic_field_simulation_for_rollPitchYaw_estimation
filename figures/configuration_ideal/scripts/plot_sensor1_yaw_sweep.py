#!/usr/bin/env python3
"""Sensor 1's magnetic-field vector across an ideal 360 deg yaw sweep.

Pitch and roll are zero. The magnet is centered on the yaw axis and Sensor 1
co-rotates around it; every plotted vector is expressed in Sensor 1's frame.
"""
...
from ideal_configuration import build_ideal_magnet, sensor_1_field_at_yaw_mT
from sweep_plotting import add_rotation_triad, add_sweep_header, style_field_axes


OUTPUT_PATH = IDEAL_DIR / "plots" / "sensor1_yaw_sweep.png"
